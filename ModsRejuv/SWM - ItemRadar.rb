...
$swm_performUpdateCheckMoreOften = true # Cambia a false para mejorar rendimiento
$swm_itemRadarMarkersLayerBitmap = nil  # Forzar recarga de gráficos al soft reset
...
class Game_Screen
  ...
  def swm_checkIsItemRadarOn?
    ...
    $swm_oldY = $game_player.y if !defined?($swm_oldY) || $swm_oldY.nil?
  ...
  def swm_updateRadar(skipEventInFrontOfPlayer = false)
    ...
    swm_clearRadarScreen
    # Buscar y dibujar ítems ocultos
